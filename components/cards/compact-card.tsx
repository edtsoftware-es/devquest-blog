...
function CompactCard({
  ...
  return (
    <article
      className={cn(
        "relative isolate flex max-w-146 items-center gap-4 rounded-[1rem] border border-neutral-200 bg-primary py-4 pr-6 pl-4 transition-border duration-300 hover:border-neutral-600",
