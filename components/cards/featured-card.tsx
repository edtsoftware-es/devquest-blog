...
function FeaturedCardShell({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="relative flex w-11/12 rounded-[1rem] border bg-primary/60 backdrop-blur-lg">
        ...
        <div className="-right-[1px] absolute bottom-[53px] z-10 size-6">
          ...
          <div className="absolute size-full rounded-br-[1rem] border-neutral-200 border-r border-b bg-primary/60" />
        </div>
