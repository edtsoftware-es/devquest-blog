  ...
  return (
    <main className="flex flex-col items-center px-4 sm:px-8">
      <div className="flex w-full flex-col items-center gap-10">
        ...
        <section className="flex w-full max-w-6xl flex-col items-center justify-center">
          <Trending
        ...
        <section className="flex w-full max-w-6xl flex-col-reverse gap-12 lg:grid lg:grid-cols-3 lg:gap-8">
